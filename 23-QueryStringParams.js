...
//   console.log(req.query); // Based on the value of these parameters we are going to
...
app.get("/api/v1/query", (req, res) => {
  ...
  if (storedProduct < 1) {
    ...
    return res.status(200).json({ success: true, data: [] }); // The more common way for showing that no data was found.

    /* In, js here if we do not add the return, then this function would have 2 return
     statements, which will cause an error, hence add a return statement while using if 
     statements.
    */
  }
